...
enum opt_code
{
  ...
  OPT_Z = 322,                               /* -Z */
  OPT_ansi = 323,                            /* -ansi */
  OPT_aux_info = 324,                        /* -aux-info */
  /* OPT_aux_info_ = 325, */                 /* -aux-info= */
  OPT_auxbase = 326,                         /* -auxbase */
  OPT_auxbase_strip = 327,                   /* -auxbase-strip */
  OPT_c = 328,                               /* -c */
  OPT_coverage = 329,                        /* -coverage */
  OPT_cxx_isystem = 330,                     /* -cxx-isystem */
  OPT_d = 331,                               /* -d */
  OPT_dumpbase = 332,                        /* -dumpbase */
  OPT_dumpdir = 333,                         /* -dumpdir */
  OPT_dumpmachine = 334,                     /* -dumpmachine */
  OPT_dumpspecs = 335,                       /* -dumpspecs */
  OPT_dumpversion = 336,                     /* -dumpversion */
  OPT_e = 337,                               /* -e */
  OPT_export_dynamic = 338,                  /* -export-dynamic */
  OPT_fPIC = 339,                            /* -fPIC */
  OPT_fPIE = 340,                            /* -fPIE */
  OPT_fabi_version_ = 341,                   /* -fabi-version= */
  OPT_faccess_control = 342,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 343,               /* -fada-spec-parent= */
  OPT_faggressive_loop_optimizations = 344,  /* -faggressive-loop-optimizations */
  OPT_falign_functions = 345,                /* -falign-functions */
  OPT_falign_functions_ = 346,               /* -falign-functions= */
  OPT_falign_jumps = 347,                    /* -falign-jumps */
  OPT_falign_jumps_ = 348,                   /* -falign-jumps= */
  OPT_falign_labels = 349,                   /* -falign-labels */
  OPT_falign_labels_ = 350,                  /* -falign-labels= */
  OPT_falign_loops = 351,                    /* -falign-loops */
  OPT_falign_loops_ = 352,                   /* -falign-loops= */
  /* OPT_fall_virtual = 353, */              /* -fall-virtual */
  OPT_fallow_parameterless_variadic_functions = 354,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 355, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 356, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 357, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 358, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 359, */  /* -fargument-noalias-global */
  OPT_fasm = 360,                            /* -fasm */
  OPT_fassociative_math = 361,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 362,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 363,                   /* -fauto-inc-dec */
  OPT_fbounds_check = 364,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 365,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 366,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 367,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 368,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 369,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 370,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 371,                        /* -fbuiltin */
  OPT_fbuiltin_ = 372,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 373,                    /* -fcall-saved- */
  OPT_fcall_used_ = 374,                     /* -fcall-used- */
  OPT_fcaller_saves = 375,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 376,       /* -fcanonical-system-headers */
  OPT_fcheck_data_deps = 377,                /* -fcheck-data-deps */
  OPT_fcheck_new = 378,                      /* -fcheck-new */
  OPT_fcombine_stack_adjustments = 379,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 380,                         /* -fcommon */
  OPT_fcompare_debug = 381,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 382,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 383,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 384,                   /* -fcompare-elim */
  OPT_fcond_mismatch = 385,                  /* -fcond-mismatch */
  OPT_fconserve_space = 386,                 /* -fconserve-space */
  OPT_fconserve_stack = 387,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 388,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 389,               /* -fconstexpr-depth= */
  OPT_fcprop_registers = 390,                /* -fcprop-registers */
  OPT_fcrossjumping = 391,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 392,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 393, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 394,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 395,               /* -fcx-limited-range */
  OPT_fdata_sections = 396,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 397,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 398,                       /* -fdbg-cnt= */
  OPT_fdce = 399,                            /* -fdce */
  OPT_fdebug_cpp = 400,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 401,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 402,            /* -fdebug-types-section */
  OPT_fdeduce_init_list = 403,               /* -fdeduce-init-list */
  /* OPT_fdefault_inline = 404, */           /* -fdefault-inline */
  OPT_fdefer_pop = 405,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 406,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 407,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 408,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 409,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_caret = 410,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 411,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 412,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 413,                /* -fdirectives-only */
  OPT_fdisable_ = 414,                       /* -fdisable- */
  OPT_fdollars_in_identifiers = 415,         /* -fdollars-in-identifiers */
  OPT_fdse = 416,                            /* -fdse */
  OPT_fdump_ = 417,                          /* -fdump- */
  OPT_fdump_ada_spec = 418,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 419,             /* -fdump-ada-spec-slim */
  OPT_fdump_final_insns = 420,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 421,              /* -fdump-final-insns= */
  OPT_fdump_go_spec_ = 422,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 423,                    /* -fdump-noaddr */
  OPT_fdump_passes = 424,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 425,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 426,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 427,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 428,                 /* -fearly-inlining */
  OPT_felide_constructors = 429,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 430,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 431, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 432,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 433,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 434,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 435,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 436,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 437,                        /* -fenable- */
  OPT_fenforce_eh_specs = 438,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 439, */           /* -fenum-int-equiv */
  OPT_fexceptions = 440,                     /* -fexceptions */
  OPT_fexcess_precision_ = 441,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 442,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 443,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 444,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 445,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 446,                /* -fextern-tls-init */
  /* OPT_fexternal_templates = 447, */       /* -fexternal-templates */
  OPT_ffast_math = 448,                      /* -ffast-math */
  OPT_ffat_lto_objects = 449,                /* -ffat-lto-objects */
  OPT_ffinite_math_only = 450,               /* -ffinite-math-only */
  OPT_ffixed_ = 451,                         /* -ffixed- */
  OPT_ffloat_store = 452,                    /* -ffloat-store */
  OPT_ffor_scope = 453,                      /* -ffor-scope */
  /* OPT_fforce_addr = 454, */               /* -fforce-addr */
  OPT_fforward_propagate = 455,              /* -fforward-propagate */
  OPT_ffp_contract_ = 456,                   /* -ffp-contract= */
  OPT_ffreestanding = 457,                   /* -ffreestanding */
  OPT_ffriend_injection = 458,               /* -ffriend-injection */
  OPT_ffunction_cse = 459,                   /* -ffunction-cse */
  OPT_ffunction_sections = 460,              /* -ffunction-sections */
  OPT_fgcse = 461,                           /* -fgcse */
  OPT_fgcse_after_reload = 462,              /* -fgcse-after-reload */
  OPT_fgcse_las = 463,                       /* -fgcse-las */
  OPT_fgcse_lm = 464,                        /* -fgcse-lm */
  OPT_fgcse_sm = 465,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 466,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 467,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 468,                         /* -fgnu-tm */
  OPT_fgnu_unique = 469,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 470,                   /* -fgnu89-inline */
  OPT_fgraphite = 471,                       /* -fgraphite */
  OPT_fgraphite_identity = 472,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 473,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 474, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 475, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 476, */                     /* -fhelp */
  /* OPT_fhelp_ = 477, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 478,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 479, */                /* -fhonor-std */
  OPT_fhosted = 480,                         /* -fhosted */
  /* OPT_fhuge_objects = 481, */             /* -fhuge-objects */
  OPT_fident = 482,                          /* -fident */
  OPT_fif_conversion = 483,                  /* -fif-conversion */
  OPT_fif_conversion2 = 484,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 485,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 486,      /* -fimplicit-inline-templates */
  OPT_fimplicit_templates = 487,             /* -fimplicit-templates */
  OPT_findirect_inlining = 488,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 489,         /* -finhibit-size-directive */
  OPT_finline = 490,                         /* -finline */
  OPT_finline_atomics = 491,                 /* -finline-atomics */
  OPT_finline_functions = 492,               /* -finline-functions */
  OPT_finline_functions_called_once = 493,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 494, */            /* -finline-limit- */
  OPT_finline_limit_ = 495,                  /* -finline-limit= */
  OPT_finline_small_functions = 496,         /* -finline-small-functions */
  OPT_finput_charset_ = 497,                 /* -finput-charset= */
  OPT_finstrument_functions = 498,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 499,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 500,/* -finstrument-functions-exclude-function-list= */
  OPT_fipa_cp = 501,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 502,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 503, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 504,                    /* -fipa-profile */
  OPT_fipa_pta = 505,                        /* -fipa-pta */
  OPT_fipa_pure_const = 506,                 /* -fipa-pure-const */
  OPT_fipa_reference = 507,                  /* -fipa-reference */
  OPT_fipa_sra = 508,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 509, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 510,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 511,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 512,              /* -fira-loop-pressure */
  OPT_fira_region_ = 513,                    /* -fira-region= */
  OPT_fira_share_save_slots = 514,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 515,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 516,                   /* -fira-verbose= */
  OPT_fivopts = 517,                         /* -fivopts */
  OPT_fjump_tables = 518,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 519,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 520,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 521,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 522, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 523,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 524,             /* -fleading-underscore */
  OPT_floop_block = 525,                     /* -floop-block */
  /* OPT_floop_flatten = 526, */             /* -floop-flatten */
  OPT_floop_interchange = 527,               /* -floop-interchange */
  OPT_floop_nest_optimize = 528,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 529, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 530,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 531,                /* -floop-strip-mine */
  OPT_flto = 532,                            /* -flto */
  OPT_flto_compression_level_ = 533,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 534,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 535,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 536,              /* -flto-partition=max */
  OPT_flto_partition_none = 537,             /* -flto-partition=none */
  OPT_flto_report = 538,                     /* -flto-report */
  OPT_flto_ = 539,                           /* -flto= */
  OPT_fltrans = 540,                         /* -fltrans */
  OPT_fltrans_output_list_ = 541,            /* -fltrans-output-list= */
  OPT_fmath_errno = 542,                     /* -fmath-errno */
  OPT_fmax_errors_ = 543,                    /* -fmax-errors= */
  OPT_fmem_report = 544,                     /* -fmem-report */
  OPT_fmem_report_wpa = 545,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 546,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 547,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 548,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 549,                /* -fmessage-length= */
  OPT_fmodulo_sched = 550,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 551,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 552,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 553,                  /* -fms-extensions */
  OPT_fmudflap = 554,                        /* -fmudflap */
  OPT_fmudflapir = 555,                      /* -fmudflapir */
  OPT_fmudflapth = 556,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 557, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 558, */                  /* -fnew-abi */
  OPT_fnext_runtime = 559,                   /* -fnext-runtime */
  OPT_fnil_receivers = 560,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 561,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 562,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 563, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 564,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 565,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 566,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 567,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 568,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 569,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 570,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 571,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 572,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 573,             /* -fomit-frame-pointer */
  OPT_fopenmp = 574,                         /* -fopenmp */
  OPT_foperator_names = 575,                 /* -foperator-names */
  OPT_fopt_info = 576,                       /* -fopt-info */
  OPT_fopt_info_ = 577,                      /* -fopt-info- */
  OPT_foptimize_register_move = 578,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 579,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 580,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 581, */           /* -foptional-diags */
  OPT_fpack_struct = 582,                    /* -fpack-struct */
  OPT_fpack_struct_ = 583,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 584,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 585,              /* -fpcc-struct-return */
  OPT_fpch_deps = 586,                       /* -fpch-deps */
  OPT_fpch_preprocess = 587,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 588,                     /* -fpeel-loops */
  OPT_fpeephole = 589,                       /* -fpeephole */
  OPT_fpeephole2 = 590,                      /* -fpeephole2 */
  OPT_fpermissive = 591,                     /* -fpermissive */
  OPT_fpic = 592,                            /* -fpic */
  OPT_fpie = 593,                            /* -fpie */
  OPT_fplan9_extensions = 594,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 595,                    /* -fplugin-arg- */
  OPT_fplugin_ = 596,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 597,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 598,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 599,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 600,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 601,                   /* -fpreprocessed */
  OPT_fpretty_templates = 602,               /* -fpretty-templates */
  OPT_fprofile = 603,                        /* -fprofile */
  OPT_fprofile_arcs = 604,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 605,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 606,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 607,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 608,              /* -fprofile-generate= */
  OPT_fprofile_report = 609,                 /* -fprofile-report */
  OPT_fprofile_use = 610,                    /* -fprofile-use */
  OPT_fprofile_use_ = 611,                   /* -fprofile-use= */
  OPT_fprofile_values = 612,                 /* -fprofile-values */
  OPT_frandom_seed = 613,                    /* -frandom-seed */
  OPT_frandom_seed_ = 614,                   /* -frandom-seed= */
  OPT_freciprocal_math = 615,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 616,            /* -frecord-gcc-switches */
  OPT_free = 617,                            /* -free */
  OPT_freg_struct_return = 618,              /* -freg-struct-return */
  OPT_fregmove = 619,                        /* -fregmove */
  OPT_frename_registers = 620,               /* -frename-registers */
  OPT_freorder_blocks = 621,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 622,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 623,              /* -freorder-functions */
  OPT_freplace_objc_classes = 624,           /* -freplace-objc-classes */
  OPT_frepo = 625,                           /* -frepo */
  OPT_frerun_cse_after_loop = 626,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 627, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 628,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 629,                    /* -fresolution= */
  OPT_frounding_math = 630,                  /* -frounding-math */
  OPT_frtti = 631,                           /* -frtti */
  OPT_fsanitize_address = 632,               /* -fsanitize=address */
  OPT_fsanitize_thread = 633,                /* -fsanitize=thread */
  OPT_fsched_critical_path_heuristic = 634,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 635,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 636,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 637,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 638,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 639,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 640,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 641,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 642,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 643,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 644,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 645,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 646,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 647,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 648,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 649,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 650,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 651, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 652,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 653,                /* -fschedule-insns2 */
  OPT_fsection_anchors = 654,                /* -fsection-anchors */
  /* OPT_fsee = 655, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 656,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 657,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 658, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 659,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 660,          /* -fselective-scheduling2 */
  OPT_fshort_double = 661,                   /* -fshort-double */
  OPT_fshort_enums = 662,                    /* -fshort-enums */
  OPT_fshort_wchar = 663,                    /* -fshort-wchar */
  OPT_fshow_column = 664,                    /* -fshow-column */
  OPT_fshrink_wrap = 665,                    /* -fshrink-wrap */
  OPT_fsignaling_nans = 666,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 667,               /* -fsigned-bitfields */
  OPT_fsigned_char = 668,                    /* -fsigned-char */
  OPT_fsigned_zeros = 669,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 670,      /* -fsingle-precision-constant */
  OPT_fsplit_ivs_in_unroller = 671,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 672,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 673,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 674, */                 /* -fsquangle */
  /* OPT_fstack_check = 675, */              /* -fstack-check */
  OPT_fstack_check_ = 676,                   /* -fstack-check= */
  OPT_fstack_limit = 677,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 678,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 679,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 680,                /* -fstack-protector */
  OPT_fstack_protector_all = 681,            /* -fstack-protector-all */
  OPT_fstack_reuse_ = 682,                   /* -fstack-reuse= */
  OPT_fstack_usage = 683,                    /* -fstack-usage */
  OPT_fstats = 684,                          /* -fstats */
  /* OPT_fstrength_reduce = 685, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 686,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 687,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 688,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 689, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 690,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 691,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 692,                    /* -fsyntax-only */
  OPT_ftabstop_ = 693,                       /* -ftabstop= */
  /* OPT_ftarget_help = 694, */              /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 695,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 696, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 697,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 698,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 699, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 700,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 701,             /* -fthreadsafe-statics */
  OPT_ftime_report = 702,                    /* -ftime-report */
  OPT_ftls_model_ = 703,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 704,               /* -ftoplevel-reorder */
  OPT_ftracer = 705,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 706,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 707,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 708,                  /* -ftrapping-math */
  OPT_ftrapv = 709,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 710,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 711,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 712,                       /* -ftree-ccp */
  OPT_ftree_ch = 713,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 714,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 715,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 716,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 717,                /* -ftree-copyrename */
  OPT_ftree_cselim = 718,                    /* -ftree-cselim */
  OPT_ftree_dce = 719,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 720,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 721,                       /* -ftree-dse */
  OPT_ftree_forwprop = 722,                  /* -ftree-forwprop */
  OPT_ftree_fre = 723,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 724,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 725,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 726,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 727,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 728,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 729,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 730, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 731,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 732,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 733,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 734,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 735,                   /* -ftree-phiprop */
  OPT_ftree_pre = 736,                       /* -ftree-pre */
  OPT_ftree_pta = 737,                       /* -ftree-pta */
  OPT_ftree_reassoc = 738,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 739, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 740,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 741,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 742,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 743,                      /* -ftree-slsr */
  OPT_ftree_sra = 744,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 745, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 746, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 747,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 748,                /* -ftree-tail-merge */
  OPT_ftree_ter = 749,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 750,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 751,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 752,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 753,                       /* -ftree-vrp */
  OPT_funit_at_a_time = 754,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 755,               /* -funroll-all-loops */
  OPT_funroll_loops = 756,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 757,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 758,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 759,             /* -funsigned-bitfields */
  OPT_funsigned_char = 760,                  /* -funsigned-char */
  OPT_funswitch_loops = 761,                 /* -funswitch-loops */
  OPT_funwind_tables = 762,                  /* -funwind-tables */
  OPT_fuse_cxa_atexit = 763,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 764,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 765,                     /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 766,                    /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 767,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 768,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 769,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 770,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 771,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 772, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 773,                /* -fvect-cost-model */
  OPT_fverbose_asm = 774,                    /* -fverbose-asm */
  /* OPT_fversion = 775, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 776,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 777,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 778,                    /* -fvisibility= */
  OPT_fvpt = 779,                            /* -fvpt */
  /* OPT_fvtable_gc = 780, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 781, */            /* -fvtable-thunks */
  OPT_fweak = 782,                           /* -fweak */
  OPT_fweb = 783,                            /* -fweb */
  OPT_fwhole_program = 784,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 785,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 786,              /* -fworking-directory */
  OPT_fwpa = 787,                            /* -fwpa */
  OPT_fwrapv = 788,                          /* -fwrapv */
  /* OPT_fxref = 789, */                     /* -fxref */
  /* OPT_fzee = 790, */                      /* -fzee */
  OPT_fzero_initialized_in_bss = 791,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 792,                      /* -fzero-link */
  OPT_g = 793,                               /* -g */
  OPT_gcoff = 794,                           /* -gcoff */
  OPT_gdwarf_ = 795,                         /* -gdwarf- */
  OPT_gen_decls = 796,                       /* -gen-decls */
  OPT_ggdb = 797,                            /* -ggdb */
  OPT_gno_pubnames = 798,                    /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 799,         /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 800,                 /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 801,                /* -gno-strict-dwarf */
  OPT_gpubnames = 802,                       /* -gpubnames */
  OPT_grecord_gcc_switches = 803,            /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 804,                    /* -gsplit-dwarf */
  OPT_gstabs = 805,                          /* -gstabs */
  OPT_gstabs_ = 806,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 807,                   /* -gstrict-dwarf */
  OPT_gtoggle = 808,                         /* -gtoggle */
  OPT_gvms = 809,                            /* -gvms */
  OPT_gxcoff = 810,                          /* -gxcoff */
  OPT_gxcoff_ = 811,                         /* -gxcoff+ */
  OPT_h = 812,                               /* -h */
  OPT_idirafter = 813,                       /* -idirafter */
  OPT_imacros = 814,                         /* -imacros */
  OPT_imultiarch = 815,                      /* -imultiarch */
  OPT_imultilib = 816,                       /* -imultilib */
  OPT_include = 817,                         /* -include */
  OPT_iplugindir_ = 818,                     /* -iplugindir= */
  OPT_iprefix = 819,                         /* -iprefix */
  OPT_iquote = 820,                          /* -iquote */
  OPT_iremap = 821,                          /* -iremap */
  ...
  OPT_m32 = 828,                             /* -m32 */
  OPT_m64 = 829,                             /* -m64 */
  OPT_march_ = 830,                          /* -march= */
  OPT_matomic = 831,                         /* -matomic */
  OPT_mbranch_cost_ = 832,                   /* -mbranch-cost= */
  OPT_mcmodel_ = 833,                        /* -mcmodel= */
  OPT_mfdiv = 834,                           /* -mfdiv */
  OPT_mhard_float = 835,                     /* -mhard-float */
  OPT_mlra = 836,                            /* -mlra */
  OPT_mmemcpy = 837,                         /* -mmemcpy */
  OPT_mmuldiv = 838,                         /* -mmuldiv */
  OPT_mplt = 839,                            /* -mplt */
  OPT_msmall_data_limit_ = 840,              /* -msmall-data-limit= */
  OPT_msoft_float = 841,                     /* -msoft-float */
  OPT_mtune_ = 842,                          /* -mtune= */
  OPT_n = 843,                               /* -n */
  ...
  OPT_print_multiarch = 864,                 /* -print-multiarch */
  OPT_print_objc_runtime_info = 865,         /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 866,                /* -print-prog-name= */
  OPT_print_search_dirs = 867,               /* -print-search-dirs */
  OPT_print_sysroot = 868,                   /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 869,    /* -print-sysroot-headers-suffix */
  OPT_quiet = 870,                           /* -quiet */
  OPT_r = 871,                               /* -r */
  OPT_remap = 872,                           /* -remap */
  OPT_s = 873,                               /* -s */
  OPT_save_temps = 874,                      /* -save-temps */
  OPT_save_temps_ = 875,                     /* -save-temps= */
  OPT_shared = 876,                          /* -shared */
  OPT_shared_libgcc = 877,                   /* -shared-libgcc */
  /* OPT_specs = 878, */                     /* -specs */
  OPT_specs_ = 879,                          /* -specs= */
  OPT_static = 880,                          /* -static */
  OPT_static_libasan = 881,                  /* -static-libasan */
  OPT_static_libgcc = 882,                   /* -static-libgcc */
  OPT_static_libgfortran = 883,              /* -static-libgfortran */
  OPT_static_libgo = 884,                    /* -static-libgo */
  OPT_static_libstdc__ = 885,                /* -static-libstdc++ */
  OPT_static_libtsan = 886,                  /* -static-libtsan */
  /* OPT_std_c__03 = 887, */                 /* -std=c++03 */
  /* OPT_std_c__0x = 888, */                 /* -std=c++0x */
  OPT_std_c__11 = 889,                       /* -std=c++11 */
  OPT_std_c__1y = 890,                       /* -std=c++1y */
  OPT_std_c__98 = 891,                       /* -std=c++98 */
  OPT_std_c11 = 892,                         /* -std=c11 */
  /* OPT_std_c1x = 893, */                   /* -std=c1x */
  /* OPT_std_c89 = 894, */                   /* -std=c89 */
  OPT_std_c90 = 895,                         /* -std=c90 */
  OPT_std_c99 = 896,                         /* -std=c99 */
  /* OPT_std_c9x = 897, */                   /* -std=c9x */
  /* OPT_std_gnu__03 = 898, */               /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 899, */               /* -std=gnu++0x */
  OPT_std_gnu__11 = 900,                     /* -std=gnu++11 */
  OPT_std_gnu__1y = 901,                     /* -std=gnu++1y */
  OPT_std_gnu__98 = 902,                     /* -std=gnu++98 */
  OPT_std_gnu11 = 903,                       /* -std=gnu11 */
  /* OPT_std_gnu1x = 904, */                 /* -std=gnu1x */
  /* OPT_std_gnu89 = 905, */                 /* -std=gnu89 */
  OPT_std_gnu90 = 906,                       /* -std=gnu90 */
  OPT_std_gnu99 = 907,                       /* -std=gnu99 */
  /* OPT_std_gnu9x = 908, */                 /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 909, */          /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 910,              /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 911, */          /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 912, */          /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 913, */          /* -std=iso9899:2011 */
  OPT_symbolic = 914,                        /* -symbolic */
  OPT_t = 915,                               /* -t */
  OPT_time = 916,                            /* -time */
  OPT_time_ = 917,                           /* -time= */
  OPT_traditional = 918,                     /* -traditional */
  OPT_traditional_cpp = 919,                 /* -traditional-cpp */
  OPT_trigraphs = 920,                       /* -trigraphs */
  OPT_u = 921,                               /* -u */
  OPT_undef = 922,                           /* -undef */
  OPT_v = 923,                               /* -v */
  OPT_version = 924,                         /* -version */
  OPT_w = 925,                               /* -w */
  OPT_wrapper = 926,                         /* -wrapper */
  OPT_x = 927,                               /* -x */
  OPT_z = 928,                               /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
